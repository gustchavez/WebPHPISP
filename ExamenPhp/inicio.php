...
<body>
	...
	<div class="encabezado row justify-content-center">
			<div class="columna col-8">
						<h1 style="color: white; text-align: center;">Noticias</h1>
			...
			<div class="contImagen col-lg-4 col-md-12 col-sm-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="#" class="btn btn-primary btn-lg btn-block">Más Información</a>
					</div>
				</div>
			</div>
			<div class="contImagen col-lg-4 col-md-12 col-sm-12">
